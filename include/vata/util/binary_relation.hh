...
/**
 * @brief  Representation of a binary relation
 */
class VATA::Util::BinaryRelation
{
	/// @todo change to dynamic_bitset?
...
public:
	...
	/// @todo: why is there the 16 magic literal? Does Jiri want to join Hogwarts?
	BinaryRelation(
