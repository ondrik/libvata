 ...
 *
 *    nOTE: specialized for set union operations. BEWARE: this is just a quick
 *    hack!! We should make this more general (intersection, binary AND, OR)
 *    ...
 *
 *****************************************************************************/

#ifndef _VATA_SET_UNION_APPLY2FUNC_HH_
#define _VATA_SET_UNION_APPLY2FUNC_HH_
...
template <
	...
	typename DataOut
>
class VATA::MTBDDPkg::SetUnionApply2Functor
{
...
private:  // Private methods
	...
	SetUnionApply2Functor(const SetUnionApply2Functor&);
	SetUnionApply2Functor& operator=(const SetUnionApply2Functor&);
	...
	NodeOutPtrType recDescend(const Node1PtrType& node1, const Node2PtrType& node2)
	{
		...
		{
			++cnt;
			VATA_DEBUG("cnt = " + VATA::Util::Convert::ToString(cnt));
